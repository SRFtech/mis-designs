                    ...
                    <div id="layoutSidenav">
                        ...
                        <main>
                            ...
                            <ol className="breadcrumb mb-4">
                                ...
                                <li className="breadcrumb-item active">Session Attendance</li>
                            </ol>
                            <div className="card mb-4">
                                ...
                                <Tabs>
                                    ...
                                    <Tab>School Sessions</Tab>
                                    <Tab>Clinic Sessions</Tab>
                                    </TabList>
                                    <TabPanel>
                                    <h2>Registration</h2>
                                    <div className="form mt-5">
                                        ...
                                        <div className="row pb-2 pt-2">
                                            <h2 className="mt-4">SRF Details</h2>
                                            <div className="form-group pb-2">
                                ...
                                <div className="card mb-4">
                                    ...
                                    <div className="form mt-5">
                                        ...
                                        <div className="row pb-2 pt-2">
                                            ...
                                            <>
                                            <h2 className="mt-4">Roll call</h2>
                                            ...
                                            <div class="form-group">
                                                <h2 className="mt-4">Session Report</h2>
                                                        <textarea className="form-control" id="formControlTextarea5"
                                                            rows="10"></textarea>
                                                    </div>
                                                <div className="form-group row px-0  pt-4">
                                                    <div className="col-sm-10 pb-4">
                                                    <button type="submit" className="btn btn-success">
                                                        Submit
                                                    </button>
