                  ...
                  <main>
                    <div className="container-fluid px-4">
                                ...
                                >
                                  <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                      Shamas Rugby Foundation (SRF) is a
                                      charitable organization established in
                                      2012.according to the srf child protection
                                      policy which states that it is a
                                      requirement for every parent/guardian to
                                      give us their consent while working with
                                      their child as a participant.
                                      Participation in rugby includes training,
                                      game, clinics, travel, and social events
                                      includes participation in a full contact
                                      sport, requires good health and fitness
                                      and can be HAZARDOUS AND PRESENT A DANGER
                                      TO PARTICIPANT. Participant and parents or
                                      guardian is qualified to participate in
                                      activities, and if at any time they
                                      believe conditions to be unsafe, he/she
                                      will immediately discontinue further
                                      participation in the activities. Risks may
                                      arise out of contact and/or participation
                                      with other participants, spectators,
                                      equipment, field, fall, collisions, rough
                                      play and other mishaps; irregular field
                                      conditions; risks may be caused by the
                                      participant’s own actions, or inaction,
                                      the actions or inaction of others
                                      participant, the condition of the
                                      facilities in which the Activities take
                                      place and/or THE NEGLIGENCE OF
                                      “RELEASEES.”
                                    </div>
                      ...
                      <div className="card mb-4">
                        <div className="card-body">
                          <p className="mb-0">
                            I hereby consent to the participation in the
                            activities and fully accept and assume all such
                            risking all responsibility for losses, cost and
                            damages incurred as a result of such participation.
                            I have completely read and understood this agreement
                            and its terms. The participant is under 18 year old,
                            as the parent/guardian i sign this agreement on
                            his/her behalf having legal responsibility.All the
                            information above is the truth.
                          </p>
                          <div className="form-group row pt-2">
                      ...
                      <div className="card mb-4">
                        <div className="card-body">
                          <p className="mb-0">
                            ...
                            responsible to ensure child safety and cover medical
                            cost related to rugby injuries.
                            <br />
                            <br />
                            <strong>
