                                    ...
                                    <div className="form mt-5">
                                        ...
                                        <div className="row pb-2 pt-2">
                                            ...
                                            <form action="/action_page.php">
                                                <input type="checkbox" id="1" name="1" defaultValue="Bike" />
                                                <label htmlFor="1"> I have a bike</label>
                                                <br />
                                                <input type="checkbox" id="2" name="2" defaultValue="Car" />
                                                <label htmlFor="2"> I have a car</label>
                                                <br />
                                                <input type="checkbox" id="3" name="3" defaultValue="Boat" />
