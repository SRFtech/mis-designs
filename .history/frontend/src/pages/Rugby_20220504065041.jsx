                                    ...
                                    <div className="form mt-5">
                                        ...
                                        <div className="row pb-2 pt-2">
                                            ...
                                            <form action="/action_page.php">
                                                <input className="m-10" type="checkbox mr-10" id="player1" name="player1" />
                                                <label htmlFor="player1">Evans Kakonzi</label>
                                                <br />
                                                <input type="checkbox" id="player2" name="player2"/>
                                                <label htmlFor="player2">Phares Otieno</label>
                                                <br />
                                                <input type="checkbox" id="player3" name="player3"/>
                                                <label htmlFor="player3"> Ronald Ogutu</label>
                                                <br />
                                                <input type="checkbox" id="player4" name="player4" />
                                                <label htmlFor="player4"> Kennedy Onyango</label>
                                                <br />
                                                <input type="checkbox" id="player5" name="player5"/>
                                                <label htmlFor="player5"> Nick Juma</label>
                                                <br />
                                                <input type="checkbox" id="player6" name="player6"/>
                                                <label htmlFor="player6"> Emily Mutua</label>
                                                <br />
                                                <input type="checkbox" id="player7" name="player7" />
                                                <label htmlFor="player7"> Philis Atieno</label>
                                                <br />
                                                <input type="checkbox" id="player8" name="player8"/>
                                                <label htmlFor="player8"> Kate Muli</label>
                                                <br />
                                                <input type="checkbox" id="player9" name="player9"/>
                                                <label htmlFor="player9"> Juma Mwanza</label>
                                                <br />
                                                <br />
                                                <div className="form-group row px-3  pt-2">
                                                    <div className="col-sm-10 pb-4">
